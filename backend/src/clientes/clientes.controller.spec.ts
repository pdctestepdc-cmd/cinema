...
describe('ClienteController', () => {
  ...
  it('POST /clientes returns 201', async () => {
    mockClienteService.create.mockResolvedValue({ id: 1, nome: "sample", email: "user@example.com", telefone: "sample" });

    await request.default(app.getHttpServer())
      .post('/clientes')
      .send({ nome: "sample", email: "user@example.com", telefone: "sample" })
      .expect(201)
      .expect((res) => {
